...
const keywordAnalysis = (text: string) => {
...
const advancedAnalysis = (text: string, keywordData: any) => {
...
export const handleSentimentAnalysis: RequestHandler = (req, res) => {
  try {
    const { text, approach = 'keyword' } = req.body as SentimentAnalysisRequest;
...
export const handleGetExamples: RequestHandler = (req, res) => {
  const examples = [
    {
